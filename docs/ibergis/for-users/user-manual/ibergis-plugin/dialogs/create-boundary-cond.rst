...
Then, a form will appear where we must specify:
...
.. important:: The boundary conditions are directly applied to the current scenario. The current scenario can be set on :ref:`dialog-boundary-cond-manager`.
